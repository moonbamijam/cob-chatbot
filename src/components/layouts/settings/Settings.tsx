...
import SettingsNavBar from "@components/layouts/settings/nav/SettingsNavBar";
import AppearanceSettings from "@components/layouts/settings/appearance/AppearanceSettings";
import SoundSettings from "@components/layouts/settings/sound/SoundSettings";
import About from "@components/layouts/settings/about/About";
